...
root = tk.Tk()
root.title("Sentiment Analysis Of  Twitter")
...
###########################################################################################################
lbl = tk.Label(root, text="___Twitter Analyzer System____", font=('times', 35,' bold '), height=1, width=60,bg="#FFBF40",fg="black")
lbl.place(x=0, y=0)
##############################################################################################################################
...
def Data_Display():
    ...
    data1 = pd.read_csv(r"D:\Project\Python Project\Tweet analysis\sent (Autosaved).csv", encoding='unicode_escape')
...
def all_ana():
    ...
    image2 =Image.open(r'D:\Project\Python Project\Tweet analysis\graph.png')
...
def Train():
    ...
    result = pd.read_csv(r"D:\Project\Python Project\Tweet analysis\sent (Autosaved).csv",encoding = 'unicode_escape')
